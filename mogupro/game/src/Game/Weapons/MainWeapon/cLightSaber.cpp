...
void cLightSaber::ShockCollisionPlayers( )
{
...
void cLightSaber::ShockCollisionDrills( )
{
}
void cLightSaber::CollisionPlayers( )
{
...
void cLightSaber::CollisionDrills( )
{
}
void cLightSaber::CollisionGems( )
{
...
void cLightSaber::Attack( const float & delta_time )
{
	if ( charge_is_attack ) {
		if ( light != nullptr ) {
...
void cLightSaber::Rotation1( ci::vec2 rotate_buf, float rotation )
{
...
void cLightSaber::Operation( const float & delta_time )
{
...
cLightSaber::cLightSaber( int player_id )
{
	push = false;
	press = false;
	pull = false;
